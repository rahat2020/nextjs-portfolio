...
এই ডকুমেন্টে এই পোর্টফোলিও ক্লায়েন্টে (Next.js 15, App Router) করা সব পরিবর্তনের সারাংশ আছে — কেন করা হয়েছে, কোন ফাইলে কী আছে, API কিভাবে call/use হচ্ছে, এবং পরে কাজে লাগার মত সব তথ্য।l
